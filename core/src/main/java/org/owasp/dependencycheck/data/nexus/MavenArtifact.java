...
public class MavenArtifact implements Serializable {
     ...
     */
    public MavenArtifact(String groupId, String artifactId, String version, boolean jarAvailable, boolean pomAvailable, Settings settings) {
        this.groupId = groupId;
        this.artifactId = artifactId;
        this.version = version;
		String base = settings.getString(Settings.KEYS.ANALYZER_CENTRAL_SECURE_CONTENT_URL);
