...
public class HttpResourceConnection implements AutoCloseable {
     ...
     * The current conn.
     */
    private HdivHttpConnection connection = null;
    /**
    ...
    private long getLastModified(URL url, boolean isRetry) throws DownloadFailedException {
    	return HdivResourceConnectionUtils.getLastModified(url, isRetry, this);
    }
     ...
     */
    @Deprecated
    long doGetLastModified(URL url, boolean isRetry) throws DownloadFailedException {
